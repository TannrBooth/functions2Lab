...
const namer = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}`)
...
greeting('Tanner','Booth', fullName => {
    console.log(`Hello, my fulll name is ${fullName}`)
    })
...
const multiplyingFactory = x => y => {
    if (x >= 5){
        ...
        console.log(`Connot multiply: the first number is smaller than 5`)
    }
}
